...
(defgeneric find-waiting-call (waiting-calls mock-controller label arguments thunk))
(defgeneric waiting-call-accept-p (waiting-call mock-controller label arguments thunk))
